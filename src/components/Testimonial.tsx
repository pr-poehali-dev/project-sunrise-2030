  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Передали им два офисных этажа с нулевой заполняемостью. Через четыре месяца — 100% аренда и арендаторы, которые продлевают договоры сами. Работать стало спокойно.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Алексей Громов</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Собственник бизнес-центра, Москва</p>
        </div>
      </div>
    </section>
  )
