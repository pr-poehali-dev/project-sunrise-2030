...
const services = [
  {
    ...
    description: "Полное управление офисными зданиями и бизнес-центрами: от поиска арендаторов до технической эксплуатации и клининга.",
    icon: (
  ...
  {
    title: "Стрит ритейл",
    description: "Управление торговыми помещениями на первых этажах: подбор концепций, работа с арендаторами, контроль потока клиентов.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "Прозрачная отчётность, своевременный сбор арендных платежей, бюджетирование и контроль расходов на эксплуатацию.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "Плановое и аварийное обслуживание инженерных систем, контроль подрядчиков, повышение класса объекта для привлечения арендаторов более высокого уровня и увеличения ставки.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
