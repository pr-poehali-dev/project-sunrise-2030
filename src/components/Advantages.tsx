...
const advantages = [
  ...
  {
    number: "02",
    title: "Снижаем расходы на эксплуатацию",
    description: "Оптимизируем эксплуатационные затраты объекта: от коммунальных платежей до технического обслуживания. Ваш актив работает эффективнее без потери качества.",
  },
  {
    number: "03",
